...
class Sertifikat extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->load->view('sertifikat/sertifikat_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'users_id' => $row->users_id,
            ...
            $this->load->view('sertifikat/sertifikat_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('sertifikat/sertifikat_form', $data);
    }
    ...
    public function update_action() 
    {
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $this->Sertifikat_model->update($this->input->post('id', TRUE), $data);
