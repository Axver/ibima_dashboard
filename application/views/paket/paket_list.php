								...
								<table class="table table-bordered" style="margin-bottom: 10px">
									...
									foreach ($paket_data as $paket)
									{
										...
										<tr>
											...
											<td><?php echo $paket->max_user ?></td>
											<td style="text-align:center" width="200px">
												<?php
												echo anchor(site_url('paket/read/'.$paket->id),'Read');
												echo ' | ';
												echo anchor(site_url('paket/update/'.$paket->id),'Update');
												echo ' | ';
												echo anchor(site_url('paket/delete/'.$paket->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"');
												?>
											</td>
										</tr>
										<?php
