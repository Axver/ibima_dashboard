					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">Downloadable <?php echo $button ?></h6>
							...
							<div class="card-body">
								...
								<form action="http://127.0.0.1:8000/api/v1/downloadable" method="post" enctype="multipart/form-data">
