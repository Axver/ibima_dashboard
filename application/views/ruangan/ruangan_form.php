					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary"><?php echo $button ?> Ruangan</h6>
							...
							<div class="card-body">
								...
								<form action="<?php echo $action; ?>" method="post">
									...
									<div class="form-group">
										<label for="varchar">Link Zoom <?php echo form_error('link_zoom') ?></label>
										<input type="text" class="form-control" name="link_zoom" id="link_zoom" placeholder="Link Zoom" value="<?php echo $link_zoom; ?>" />
									</div>
									<div class="form-group">
									...
									<div class="form-group">
										<label for="varchar">Id Topik <?php echo form_error('topik_id') ?></label>
								...
								<script>
                                    let sp='<?php echo $topik_id ?>';
                                    $("#topik_id").val(sp).change();
								</script>
