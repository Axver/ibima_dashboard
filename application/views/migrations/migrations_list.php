    ...
    <body>
		...
		<th>Action</th>
			...
			<td style="text-align:center" width="200px">
				<?php 
				echo anchor(site_url('migrations/read/'.$migrations->id),'Read'); 
				echo ' | '; 
				echo anchor(site_url('migrations/update/'.$migrations->id),'Update'); 
				echo ' | '; 
				echo anchor(site_url('migrations/delete/'.$migrations->id),'Delete','onclick="javasciprt: return confirm(\'Are You Sure ?\')"'); 
				?>
			</td>
		</tr>
                <?php
