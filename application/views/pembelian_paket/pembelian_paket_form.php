					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">Update Status Pembayaran Pembelian Paket</h6>
							...
							<div class="card-body">
								...
								<form action="<?php echo $action; ?>" method="post">
									...
									<div class="form-group">
										...
										<input type="hidden" class="form-control" name="list_email" id="list_email" placeholder="List Email" value="<?php echo $list_email; ?>" />
									</div>
									<div class="form-group">
