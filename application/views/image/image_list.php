						...
						<div class="card shadow mb-12">
							...
							<div class="card-body">
								...
								<div class="row" style="margin-bottom: 10px">
									<div class="col-md-4">
										<?php echo anchor(site_url('image/create'),'Create', 'class="btn btn-primary"'); ?>
									</div>
									...
									<div class="col-md-3 text-right">
										<form action="<?php echo site_url('image/index'); ?>" class="form-inline" method="get">
											<div class="input-group">
							...
							{
								?>
								<a href="<?php echo site_url('image'); ?>" class="btn btn-default">Reset</a>
								<?php
							}
							?>
