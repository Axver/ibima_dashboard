					...
					<div class="col-xl-12 col-lg-12">
						<div class="card shadow mb-12">
							...
							<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								<h6 class="m-0 font-weight-bold text-primary">Modul <?php echo $button ?></h6>
							...
							<div class="card-body">
								...
								<form action="<?php echo $action; ?>" method="post">
									...
									<div class="form-group">
										<label for="varchar">Nama Modul <?php echo form_error('nama_modul') ?></label>
										<input type="text" class="form-control" name="nama_modul" id="nama_modul" placeholder="Nama Modul" value="<?php echo $nama_modul; ?>" />
									</div>
									<div class="form-group">
									...
									<a href="<?php echo site_url('modul') ?>" class="btn btn-default">Cancel</a>
								</form>
